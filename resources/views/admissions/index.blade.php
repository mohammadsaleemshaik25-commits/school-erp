    ...
    <div class="row g-3 mb-4" id="kpi-container">
        ...
        <div class="col-md">
            <div class="card border-0 shadow-sm rounded-4 border-start border-success border-4 h-100">
                <div class="card-body p-3">
                    <div class="small text-uppercase fw-bold text-muted mb-1">Today's Admissions</div>
                    <div class="h3 fw-bold mb-0 text-success" id="stat-today-admissions">...</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card border-0 shadow-sm rounded-4 border-start border-warning border-4 h-100">
                <div class="card-body p-3">
                    <div class="small text-uppercase fw-bold text-muted mb-1">Pending Verification</div>
        ...
        <div class="col-md">
            <div class="card border-0 shadow-sm rounded-4 border-start border-info border-4 h-100">
                <div class="card-body p-3">
                    <div class="small text-uppercase fw-bold text-muted mb-1">Approved Admissions</div>
                    <div class="h3 fw-bold mb-0 text-info" id="stat-approved-admissions">...</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card border-0 shadow-sm rounded-4 border-start border-danger border-4 h-100">
                <div class="card-body p-3">
                    <div class="small text-uppercase fw-bold text-muted mb-1">Rejected Admissions</div>
                    <div class="h3 fw-bold mb-0 text-danger" id="stat-rejected-admissions">...</div>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card border-0 shadow-sm rounded-4 border-start border-secondary border-4 h-100">
                <div class="card-body p-3">
                    <div class="small text-uppercase fw-bold text-muted mb-1">Transfer Admissions</div>
                    <div class="h3 fw-bold mb-0 text-secondary" id="stat-transfer-admissions">...</div>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function () {
        ...
        function loadStats() {
            $.get("{{ route('admissions.stats') }}", function(data) {
                ...
                $('#stat-today-admissions').text(data.today_admissions);
                $('#stat-pending-verification').text(data.pending_verification);
                $('#stat-approved-admissions').text(data.approved_admissions);
                $('#stat-rejected-admissions').text(data.rejected_admissions);
                $('#stat-transfer-admissions').text(data.transfer_admissions);
            });
        }
        loadStats();
