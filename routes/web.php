...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::middleware('role:Principal,Correspondent,Admin,Administrator')->group(function () {
        ...
        Route::get('/admissions/transfer/timeline/{studentId}', [AdmissionTransferController::class, 'timeline'])->name('admissions.transfer.timeline');
        ...
        Route::post('/admissions/{admission}/admit', [AdmissionController::class, 'admit'])->name('admissions.admit');
